...
from PySide6.QtCore import Slot, QPoint, QTimer
from PySide6.QtGui import QPainter, QPen, QColor, QFont, Qt, QBrush, QMouseEvent, QPalette
import numpy as np
...
class MainWindow(QMainWindow):
    ...
    def set_ui_before_match_start(self):
        '''比赛开始前的UI设置'''
    ...
    def set_ui_after_match_start(self):
        '''比赛开始时，更新一些UI的状态'''
    ...
    def update_count_down_lcdNum(self):
        '''更新倒计时的显示'''
